  ...
  <div class="relative">
    ...
    <div class="relative w-80">
      <input
        ...
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-highlight w-80"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
      ...
      <div
        v-if="query.length > 0"
        class="absolute top-0 right-0 text-2xl mr-3 cursor-pointer text-gray-600 hover:text-black"
        style="top:2px;"
        @click="reset"
      >
        &times;
