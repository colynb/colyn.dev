<template>
  <footer class="bg-primary text-white px-3">
    <div
      class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8"
    >
      <div class="mb-8 lg:mb-0">
        <div>
          Copyright {{ new Date().getFullYear() }} Colyn Brown (InfrontLabs,
      ...
      <ul class="flex items-center">
        <li class="mr-8">
          <a
            href="mailto:hello@infrontlabs.com"
